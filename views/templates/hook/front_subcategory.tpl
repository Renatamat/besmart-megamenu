...
<ul class="{if $level==1}cbp-links cbp-category-tree C {elseif $level==2}cbp-hrsub-level2{elseif $level==3}cbp-hrsub-level2 cbp-hrsub-level3{/if}">
{foreach $categories as $category}
	...
	<div class="cbp-category-link-w BBB">
